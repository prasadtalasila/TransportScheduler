defmodule StationTest do
	...
	test "Receive a itinerary search query" do
		...
		stationState = %StationStruct{loc_vars: %{"delay": 0.38,
			...
			dst_station: 2, dept_time: 25000, arrival_time: 35000}], station_number: 1,
	...
	test "Send completed search query to neighbours" do
		...
		itinerary = [%{qid: "0300", src_station: 0, dst_station: 3, day: 0, arrival_time: 0, end_time: 999999},
	...
	test "Does not forward queries with self loops" do
		...
		itinerary = [%{qid: "0300", src_station: 1, dst_station: 3, day: 0, arrival_time: 0, end_time: 999999},
			%{vehicleID: "99", src_station: 1, mode_of_transport: "train",
			dst_station: 2, dept_time: 10000, arrival_time: 20000}, %{vehicleID: "100", src_station: 2, mode_of_transport: "train",
			dst_station: 1, dept_time: 25000, arrival_time: 30000}]
	...
	# Test 9
	test "No query is forwarded from a Station with no viable paths." do
		stationState = %StationStruct{loc_vars: %{"delay": 0.38,
			"congestion": "low", "disturbance": "no"},
			schedule: [%{vehicleID: "100", src_station: 1, mode_of_transport: "bus",
			dst_station: 2, dept_time: 15000, arrival_time: 35000}],station_number: 1,
			congestion_low: 4, choose_fn: 1}
	...
	test "The correct itinerary is forwarded to the next station" do
		...
		proper_itinerary = [%{qid: "0300", src_station: 0, dst_station: 3, day: 0, arrival_time: 0, end_time: 999999},
				%{vehicleID: "99", src_station: 0, mode_of_transport: "train",
				dst_station: 1, dept_time: 10000, arrival_time: 20000},
	...
	# Test 11
	test "The correct itinerary is forwarded to the next station with the day updated" do
		stationState = %StationStruct{loc_vars: %{"delay": 0.38,
			"congestion": "low", "disturbance": "no"},
			schedule: [%{vehicleID: "100", src_station: 1, mode_of_transport: "bus",
			dst_station: 2, dept_time: 25000, arrival_time: 35000}],station_number: 1,
		...
		itinerary = [%{qid: "0300", src_station: 0, dst_station: 3, day: 0, arrival_time: 0, end_time: 999999},
			%{vehicleID: "99", src_station: 0, mode_of_transport: "train",
			dst_station: 1, dept_time: 10000, arrival_time: 86400}]

		proper_itinerary = [%{qid: "0300", src_station: 0, dst_station: 3, day: 1, arrival_time: 0, end_time: 999999},
				%{vehicleID: "99", src_station: 0, mode_of_transport: "train",
				dst_station: 1, dept_time: 10000, arrival_time: 86400},
				%{vehicleID: "100", src_station: 1, mode_of_transport: "bus",
				dst_station: 2, dept_time: 25000, arrival_time: 35000}]
	...
	test "Terminated queries are handed over to query collector with correct itinerary" do
		...
		itinerary = [%{qid: "0100", src_station: 0, dst_station: 1, day: 0, arrival_time: 0, end_time: 999999},
			%{vehicleID: "99", src_station: 0, mode_of_transport: "train",
			dst_station: 1, dept_time: 10000, arrival_time: 20000}]

		proper_itinerary=[%{qid: "0100", src_station: 0, dst_station: 1, day: 0, arrival_time: 0, end_time: 999999},
			%{vehicleID: "99", src_station: 0, mode_of_transport: "train",
			dst_station: 1, dept_time: 10000, arrival_time: 20000}]
	...
	test "Consumes rapid stream of mixed input queries" do
		query = [%{qid: "0100", src_station: 0, dst_station: 1, day: 0, arrival_time: 0, end_time: 999999}]
