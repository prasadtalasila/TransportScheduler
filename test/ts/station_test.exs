...
defmodule StationTest do
	...
	test "List feasible neighbouring stations" do
		...
		Station.update(station, ss=%StationStruct{locVars: %{"delay": 0.38,
			...
			mode_of_transport: "train"}, %{vehicleID: 2222, src_station: 1,
			dst_station: 2, dept_time: "13:12:00", arrival_time: "14:32:00",
			mode_of_transport: "train"}, %{vehicleID: 3333, src_station: 1,
			dst_station: 2, dept_time: "03:12:00", arrival_time: "10:32:00",
			mode_of_transport: "train"}, %{vehicleID: 4444, src_station: 1,
			dst_station: 2, dept_time: "19:12:00", arrival_time: "20:32:00",
			mode_of_transport: "train"}]})
		time="04:42:00"

		#IO.puts Station.get_vars(station).schedule
		#IO.puts Station.check_neighbours(station, time)
		# assert Station.check_neighbours(station, time) == [%{arrival_time:
		# "14:32:00", dept_time: "13:12:00", dst_station: 2, mode_of_transport:
	  #{}"train", src_station: 1, vehicleID: 2222}, %{arrival_time: "16:32:00",
	  # dept_time: "07:12:00", dst_station: 2, mode_of_transport: "train",
	  # src_station: 1, vehicleID: 1111}, %{arrival_time: "20:32:00", dept_time:
	  # "19:12:00", dst_station: 2, mode_of_transport: "train", src_station: 1,
	  # vehicleID: 4444}]
	end
