...
defmodule InputParserTest do
  ...
  test "populate data structures" do
    ...
    assert InputParser.get_station_struct(pid, "Alnavar Junction")==%StationStruct{choose_fn: nil, congestion_high: nil, congestion_low: nil, locVars: %{congestion: "low", congestionDelay: nil, delay: 0.22, disturbance: "no"}, pid: nil, schedule: [%{arrival_time: 45000, dept_time: 900, dst_station: 2, mode_of_transport: "train", src_station: 5, vehicleID: 11043}, %{arrival_time: 63300, dept_time: 300, dst_station: 7, mode_of_transport: "train", src_station: 5, vehicleID: 19019}], station_name: "Alnavar Junction", station_number: 5}
