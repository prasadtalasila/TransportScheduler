defmodule TS.API.Supervisor do
	@moduledoc """
	Module for implementing API process supervision functionality. Supervisor
	process supervises other processes, which we refer to as child processes.
	In the event of API process crashing, the TS.API.Supervisor is responsible
	for restarting it based on the exit reasons and strategies mentioned.
	...
	are terminated.	Then the terminated child process and the rest of the child
