defmodule StationStruct do
  defstruct locVars: %{delay: nil, congestionDelay: nil, congestion: nil, disturbance: nil}, schedule: [%{vehicleID: nil, src_station: nil, dst_station: nil, dept_time: nil, arrival_time: nil, mode_of_transport: nil}], station_number: nil, station_name: nil, pid: nil, congestion_low: nil, congestion_high: nil
end
...
# congestion_low: 2, congestion_high: 3
